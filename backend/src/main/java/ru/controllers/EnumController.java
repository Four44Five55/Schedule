...
public class EnumController {
    ...
    // пользователь, а не релиз — правило в docs/CONVENTIONS.md. Виды ЗАНЯТИЙ остаются enum'ом и остаются
     ...
     * отрасли («канд наук»): она нужна, когда отрасль не указана, — записи «кн» не существует.</p>
     */
