...
public enum KindOfStudy {
    ...
    // Курсовой проект заведён по выгрузке сторонней программы (2026-08-17): в ней он встречается
    // двумя обозначениями — «КП» и «КуР», и оба означают его же (правило заказчика). Категория
    // PRACTICE: проект отрабатывается группой по ходу курса и переставляется наравне с практиками;
    // итоговой аттестацией (ASSESSMENT) он не является — её в курсе объявляет «Отчет» подвала.
    COURSE_PROJECT("Курсовой проект", "КП", Category.PRACTICE),
