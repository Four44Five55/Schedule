 ...
 *
 * <p><b>Степень двумерна:</b> «к.т.н.» = уровень (кандидат) × отрасль науки (технические).
 ...
 *
 * <p>Сокращения — <b>без точек</b> (решение заказчика): точка это часть формата, а не данных,
 * и расставляет её форматтер. {@code abbreviation} — буквенная часть составного сокращения
 * («к» → «к.т.н.»), {@code standalone} — форма для случая, когда отрасль не указана
 * («канд наук»): «к.н.» такой записи не существует.</p>
 */
public enum AcademicDegree {
    ...
    /** Буквенная часть составного сокращения: «к» в «к.т.н.». */
