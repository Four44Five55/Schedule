...
public final class DisciplineFooterParser {
     ...
     * @param lecturers   «Лектор» — подписи как в файле: «Тополев В.Ф. двн проф», «п/п-к Астахов С.В.»
    ...
    /** «Тополев В.Ф. двн проф; п/п-к Астахов С.В.» → две подписи; звание и степень остаются при них. */
