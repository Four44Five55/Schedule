 ...
 * ставим»). Владелец правила один, потому что сверка обязана показывать <b>ту самую</b> комнату, в
 * которую потом встанет занятие: иначе человек подтверждает одно сопоставление, а в расписание
 * попадает другое.</p>
 *
