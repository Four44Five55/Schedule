...
**Дата обновления:** 2026-07-12 (раздел «Следующие шаги»; архитектурные разделы — от 2026-06-27)
**Основной класс:** `DistributionDiscipline` (оркестратор)
**Текущая ветка:** `feat-final-schedule-in-bd`
**Статус:** Ручная раскладка и подсказки редактору; оптимизация скорости планировщика
...
- 🔴 **Пересортировка возит аудиторию мимо подбора** — `TrackReorderService` переносит размещение в
  другую ячейку со старой комнатой, не проверяя занятость. 77 конфликтов из 179; вернутся после
  первого же переноса, несмотря на починку подбора. Следующий шаг по теме.
...
*Документ обновлён 2026-07-12 (актуализированы «следующие шаги»; архитектурные разделы выше — от 2026-06-27)*
*Текущая ветка: feat-final-schedule-in-bd*
