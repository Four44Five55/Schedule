...
**Статус:** Активная разработка фронтенда; перенос занятий, отображение и ввод ограничений
...
- ⏳ **B: ввод ограничений перед генерацией** в `PlannerManager` (счётчик «учтено N» + та же модалка).
- ⏳ Рисование ограничений мышью по сетке (выделение дней) — улучшение поверх модалки.
...
*Документ обновлён 2026-06-27 (единый каркас сетки, отображение и ввод ограничений)*
*Текущая ветка: feat-final-schedule-in-bd*
